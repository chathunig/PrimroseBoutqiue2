            ...
            public void onClick(View v) {
                ...
                mAuth.createUserWithEmailAndPassword(email,password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        {
                            Toast.makeText(UserRegis.this,"You are successfully Registered", Toast.LENGTH_SHORT).show();
                            startActivity(new Intent(UserRegis.this, UserLogin.class));

                        }
                        else
                        {
                            Toast.makeText(UserRegis.this,"You are not Registered! Try again",Toast.LENGTH_SHORT).show();
                        }
                    }
                });
